<template>
    <div class="like-container">
        <button @click="likeComment(commentId)" v-if="isLiked == false"><i class="fas fa-thumbs-up"></i></button>
        <button @click="unlikeComment" v-else-if="isLiked == true"><i class="fas fa-thumbs-down"></i></button>
